...
def ik_solve(limb, robotPose):
	...
	lquat = quaternion_from_euler(robotPose.LH_roll, robotPose.LH_pitch, robotPose.LH_yaw, 'sxyz')
	rquat = quaternion_from_euler(robotPose.RH_roll, robotPose.RH_pitch, robotPose.RH_yaw, 'sxyz')
