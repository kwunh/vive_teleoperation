...
class OpenVrGlRenderer(list):
	...
	#image_left = self.left_image.get_image()
        #image_right =  self.right_image.get_image()
	
	image_left= cv2.imread('sword_art_online.jpg') 
	image_right= cv2.imread('sword_art_online.jpg')
